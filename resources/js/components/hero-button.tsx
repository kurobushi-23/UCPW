...
export function HeroButtons() {
    ...
    return (
        <div className="flex w-full max-w-sm justify-center gap-2 px-4 sm:max-w-md sm:gap-3 md:max-w-lg md:gap-4">
            {/* Layanan Button - Menuju halaman services */}
            <Link
                href="/services" // Ganti dengan route yang sesuai
            ...
            {/* Hubungi Kami Button - Menuju halaman contact atau section */}
            <Link
                href="/#contact" // Ganti dengan route atau anchor yang sesuai
